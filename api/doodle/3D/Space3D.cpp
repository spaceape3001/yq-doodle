...
namespace yq::doodle {
    Space3DInfo::Space3DInfo(std::string_view zName, SpaceInfo& base, const std::source_location& sl) : SpaceInfo(zName, base, sl)
    {
        set(Flag::SPACE);
    }
    ...
    Space3D::Space3D(Project&prj, const Space3D&cp) : Space(prj, cp),
