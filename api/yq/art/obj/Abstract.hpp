...
namespace yq::art {
    ...
    public:
        ...
        revision_t  revision() const { return m_revision.all; }
        
        //! Setters should call this; and when you're using a property to set
        //! \note Better to overcall than undercall
        virtual void bump();
    ...
    private:    StringAnyMap            m_attributes;
    private:    std::string             m_key;
    protected:  AllLocal<revision_t>    m_revision{};
    };
