...
////////////////////////////////////////////////////////////////////////////////
    ...
    Any   DObject::attribute(const std::string& k) const
    {
        Any a   = attribute(LOCAL, k);
        if(a.valid())
            return a;
    ...
    Any       DObject::attribute(default_k, const std::string& k) const
    {
    ...
    Any         DObject::attribute(global_k, const std::string& k) const
    {
        return m_project.attribute(k);
    }

    Any         DObject::attribute(local_k, const std::string& k) const
    {
...
YQ_OBJECT_IMPLEMENT(yq::diagram::DObject)
