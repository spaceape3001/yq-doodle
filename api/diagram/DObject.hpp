...
#include <diagram/bit/Dim.hpp>
#include <diagram/bit/ID.hpp>
#include <diagram/typedef/revision.hpp>
#include <diagram/typedef/dobject.hpp>
#include <diagram/keywords.hpp>
...
namespace yq::diagram {
    ...
    */
    class DObject : public Object {
        ...
        YQ_DIAGRAM_DECLARE_ABSTRACT(DObject, Object)
    ...
    public:
        ...
        */
        ...
        Any                     attribute(default_k, const std::string&) const;
        
        //! Attribute (ONLY) on this object
        //! \note This excludes any "default"
        Any                     attribute(local_k, const std::string&) const;

        Any                     attribute(global_k, const std::string&) const;
